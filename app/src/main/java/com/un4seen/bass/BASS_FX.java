...
@SuppressWarnings("ALL") public class BASS_FX {
	...
	/*
		Multi-ptr order of each ptr is as follows:
	...
	*/
    ...
    public static final int BASS_BFX_CHAN1 = 1;        // left-front ptr
    public static final int BASS_BFX_CHAN2 = 2;        // right-front ptr
    ...
    // DSP effects
    public static final int BASS_FX_BFX_ROTATE = 0x10000;        // A channels volume ping-pong	/ multi ptr
    public static final int BASS_FX_BFX_ECHO = 0x10001;            // Echo							/ 2 channels max	(deprecated)
    public static final int BASS_FX_BFX_FLANGER = 0x10002;        // Flanger						/ multi ptr		(deprecated)
    public static final int BASS_FX_BFX_VOLUME = 0x10003;        // Volume						/ multi ptr
    public static final int BASS_FX_BFX_PEAKEQ = 0x10004;        // Peaking Equalizer			/ multi ptr
    public static final int BASS_FX_BFX_REVERB = 0x10005;        // Reverb						/ 2 channels max	(deprecated)
    public static final int BASS_FX_BFX_LPF = 0x10006;            // Low Pass Filter 24dB			/ multi ptr		(deprecated)
    public static final int BASS_FX_BFX_MIX = 0x10007;            // Swap, remap and mix channels	/ multi ptr
    public static final int BASS_FX_BFX_DAMP = 0x10008;            // Dynamic Amplification		/ multi ptr
    public static final int BASS_FX_BFX_AUTOWAH = 0x10009;        // Auto Wah						/ multi ptr
    public static final int BASS_FX_BFX_ECHO2 = 0x1000a;        // Echo 2						/ multi ptr		(deprecated)
    public static final int BASS_FX_BFX_PHASER = 0x1000b;        // Phaser						/ multi ptr
    public static final int BASS_FX_BFX_ECHO3 = 0x1000c;        // Echo 3						/ multi ptr		(deprecated)
    public static final int BASS_FX_BFX_CHORUS = 0x1000d;        // Chorus/Flanger				/ multi ptr
    public static final int BASS_FX_BFX_APF = 0x1000e;            // All Pass Filter				/ multi ptr		(deprecated)
    public static final int BASS_FX_BFX_COMPRESSOR = 0x1000f;    // Compressor					/ multi ptr		(deprecated)
    public static final int BASS_FX_BFX_DISTORTION = 0x10010;    // Distortion					/ multi ptr
    public static final int BASS_FX_BFX_COMPRESSOR2 = 0x10011;    // Compressor 2					/ multi ptr
    public static final int BASS_FX_BFX_VOLUME_ENV = 0x10012;    // Volume envelope				/ multi ptr
    public static final int BASS_FX_BFX_BQF = 0x10013;            // BiQuad filters				/ multi ptr
    public static final int BASS_FX_BFX_ECHO4 = 0x10014;        // Echo 4						/ multi ptr
    public static final int BASS_FX_BFX_PITCHSHIFT = 0x10015;    // Pitch shift using FFT		/ multi ptr		(not available on mobile)
    public static final int BASS_FX_BFX_FREEVERB = 0x10016;        // Reverb using "Freeverb" algo	/ multi ptr
    // BiQuad Filters
	...
	*/
    ...
    public static final int BASS_ATTRIB_TEMPO_OPTION_USE_AA_FILTER = 0x10010;        // TRUE (default) / FALSE (default for multi-ptr on mobile devices for lower CPU usage)
    ...
    public static class BASS_BFX_MIX {
        public int[] lChannel;                    // an array of channels to mix using BASS_BFX_CHANxxx flag/s (lChannel[0] is left ptr...)
    }
