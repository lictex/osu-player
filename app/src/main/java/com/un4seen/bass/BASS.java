...
@SuppressWarnings("ALL") public class BASS {
    ...
    public static final int BASS_ERROR_NOCHAN = 18;    // can't get a free ptr
    ...
    public static final int BASS_ERROR_DECODE = 38;    // the ptr is a "decoding ptr"
    ...
    public static final int BASS_ERROR_ENDED = 45;    // the ptr/file has ended
    ...
    public static final int BASS_ATTRIB_MUSIC_VOL_CHAN = 0x200; // + ptr #
    ...
    public static final int BASS_DATA_FFT_INDIVIDUAL = 0x10;    // FFT flag: FFT for each ptr, else all combined
    ...
    public interface SYNCPROC {
		...
		ptr: Channel that the sync occured in
    ...
    public interface DSPPROC {
		...
		ptr: Channel that the DSP is being applied to
